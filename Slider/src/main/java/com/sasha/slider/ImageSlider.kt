...
import com.sasha.slider.adapters.ViewPagerAdapter
...
import com.sasha.slider.interfaces.ItemClickListener
import com.sasha.slider.interfaces.TouchListener
...
class ImageSlider @JvmOverloads constructor(
    ...
    init {
        ...
        placeholder = typedArray.getResourceId(R.styleable.ImageSlider_iss_placeholder, R.drawable.progress_loading)
